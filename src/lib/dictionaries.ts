const en = {
    ...
    // Users
    usersPage: {
        title: 'Users & Workers Management',
        description: 'Manage staff, workers, and permissions',
        addUser: 'Add User',
        staffTab: 'Staff',
        workersTab: 'Workers',
        staffTitle: 'Staff',
        staffDescription: 'List of staff and supervisors in the system',
        workersTitleWithCount: 'Workers data ({count} records)',
        workersDescription: 'List of workers in the system',
        name: 'Name',
        email: 'Email',
        role: 'Role',
        assignedResidences: 'Assigned residences',
        actions: 'Actions',
        ...
        confirmDeleteUser: 'This will permanently delete the user "{name}".',
        confirmDeleteWorker: 'This will permanently delete the worker "{name}".',
        cancel: 'Cancel',
    ...
    userForm: {
        ...
        editTitle: 'Edit User',
        addDescription: 'Fill in the details for the new user.',
        editDescription: "Update the user's details and preferences.",
        nameLabel: 'Name',
        namePlaceholder: 'e.g., Ahmed Al-Farsi',
        emailLabel: 'Email',
        emailPlaceholder: 'e.g., ahmed@email.com',
        roleLabel: 'Role',
        selectRolePlaceholder: 'Select a role',
        assignedResidencesLabel: 'Assigned Residences',
        assignedResidencesDescription: 'Select the residences this user has access to.',
        loadingResidences: 'Loading residences...',
...
const ar = {
    ...
    // Users
    usersPage: {
        title: 'إدارة المستخدمين والعمال',
        description: 'إدارة الموظفين والعمال والصلاحيات',
        addUser: 'إضافة مستخدم',
        staffTab: 'الموظفين',
        workersTab: 'العمال',
        staffTitle: 'الموظفين',
        staffDescription: 'قائمة الموظفين والمشرفين في النظام',
        workersTitleWithCount: 'معاينة البيانات ({count} سجل)',
        workersDescription: 'قائمة العمال في النظام',
        name: 'الاسم',
        email: 'البريد الإلكتروني',
        role: 'الدور',
        assignedResidences: 'المقرات المخصصة',
        actions: 'الإجراءات',
        ...
        confirmDeleteUser: 'سيتم حذف المستخدم "{name}" نهائياً',
        confirmDeleteWorker: 'سيتم حذف العامل "{name}" نهائياً',
        cancel: 'إلغاء',
        confirmDelete: 'حذف',
        workerRoleLabel: 'عامل',
    },
    userForm: {
        addTitle: 'إضافة مستخدم جديد',
        editTitle: 'تعديل المستخدم',
        addDescription: 'أدخل بيانات المستخدم الجديد.',
        editDescription: 'قم بتحديث بيانات وتفضيلات المستخدم.',
        nameLabel: 'الاسم',
        namePlaceholder: 'مثال: أحمد الفارسي',
        emailLabel: 'البريد الإلكتروني',
        emailPlaceholder: 'مثال: ahmed@email.com',
        roleLabel: 'الدور',
        selectRolePlaceholder: 'اختر الدور',
        assignedResidencesLabel: 'المقرات المخصصة',
        assignedResidencesDescription: 'اختر المقرات التي يمكن لهذا المستخدم الوصول إليها.',
        loadingResidences: 'جاري تحميل المقرات...',
        preferencesTitle: 'تفضيلات المستخدم',
        themeModeLabel: 'وضع الثيم',
        themeModeLight: 'فاتح',
        themeModeDark: 'داكن',
        themeModeSystem: 'حسب النظام',
