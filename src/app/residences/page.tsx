...
const RoomItem = React.memo(function RoomItem({ roomName, canEdit, onDelete }: { roomName: string, canEdit: boolean, onDelete: () => void }) {
  return (
    <div className="flex items-center justify-between p-2 bg-background rounded-md text-sm border">
      <div className="flex items-center gap-2">
      ...
      {canEdit && (
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Are you sure?</AlertDialogTitle>
              <AlertDialogDescription>This will delete room "{roomName}".</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={onDelete}>Delete</AlertDialogAction>
