...
// Firebase auth disabled during Cloudflare migration
...
export default function ProfilePage() {
  ...
  const [themeMode, setThemeMode] = useState<any>(currentUser?.themeSettings?.mode || 'system');
  ...
  const handleChangePassword = async () => {
    toast({ title: 'Unavailable', description: 'Password change is disabled during Cloudflare migration.' });
  };
