 ...
 */ function getRecaptcha() {
    let isEnterprise = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
    var _a;
    if (isEnterprise) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function exchangeToken(param, heartbeatServiceProvider) {
    let { url, body } = param;
    const headers = {
 ...
 */ async function readTokenFromStorage(app) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isIndexedDBAvailable"])()) {
        ...
        try {
            ...
            logger.warn("Failed to read token from IndexedDB. Error: ".concat(e));
        }
        return token;
    }
    return undefined;
...
async function readOrCreateDebugTokenFromStorage() {
    ...
    if (!existingDebugToken) {
        ...
        writeDebugTokenToIndexedDB(newToken).catch((e)=>logger.warn("Failed to persist debug token to IndexedDB. Error: ".concat(e)));
        return newToken;
    } else {
 ...
 */ async function getToken$2(appCheck) {
    let forceRefresh = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, shouldLogErrors = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
 ...
 */ function makeDiv(app) {
    const divId = "fire_app_check_".concat(app.name);
 ...
 */ function initializeAppCheck() {
    let app = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])(), options = arguments.length > 1 ? arguments[1] : void 0;
 ...
 */ function _activate(app, provider) {
    let isTokenAutoRefreshEnabled = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
...
//# sourceMappingURL=node_modules_%40firebase_ff651fab._.js.map