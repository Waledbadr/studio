...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      const updated: User = {
        ...
        language: locale,
        themeSettings: { colorTheme, mode: themeMode },
      };
  ...
  const handleChangePassword = async () => {
    toast({
      title: 'Unavailable',
      description: 'Password management is handled by the Cloudflare auth branch. Please use the login form or contact an administrator to reset your password.',
      variant: 'destructive',
    });
  };
